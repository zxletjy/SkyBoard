...
void navUkfRotateVectorByQuat(float *vr, float *v, float q1, float q2, float q3, float q4)
{
    float w, x, y, z;
...
void GetEarthAcc(Vector3f Acc, Vector3f* earth)
{
	...
	navUkfRotateVectorByQuat(acc, accIn, IMU_QCF.Q1, IMU_QCF.Q2, IMU_QCF.Q3, IMU_QCF.Q4);
	acc[2] += GRAVITY;
